...
export const deleteClientModal = () => {
  ...
  deleteModalTitle.classList.add('model__title', 'delete-modal__title');
  deleteModalDelete.classList.add('delete-modal__delete', 'btn-reset', 'site-btn');
  deleteModalBack.classList.add('delete-modal__back', 'modal__btn-back', 'btn-reset');
  modalClose.classList.add('modal__close', 'btn-reset');

  deleteModalTitle.textContent = 'Delete client';
  deleteModalText.textContent = 'Do you really want to delete this contact?';
